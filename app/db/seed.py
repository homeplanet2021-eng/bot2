...
CONTENT_PAGES = [
    ("home", "Horizon VPN", "Добро пожаловать в Horizon VPN. Безопасный доступ и высокая скорость."),
    ("faq", "Вопросы и ответы", "Ответы на частые вопросы о подписке, оплате и устройствах."),
    ("offer", "Публичная оферта", "Условия предоставления услуги Horizon VPN."),
    ("privacy", "Политика конфиденциальности", "Мы защищаем ваши данные и не передаем их третьим лицам."),
    ("terms", "Правила сервиса", "Правила использования Horizon VPN, включая запрет злоупотреблений."),
]
